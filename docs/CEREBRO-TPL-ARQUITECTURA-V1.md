...
Actualizado 2026-09-04: esta nota decía que la implementación usaba localStorage como prototipo y debía migrarse a Supabase con RLS antes de producción. Esa migración ya ocurrió — las entidades V1 de arriba viven hoy en tablas reales de Supabase con RLS (tpl_actores, tpl_proyectos, tpl_proyecto_actores, tpl_necesidades_proyecto, tpl_servicios, tpl_partner_servicios, tpl_ordenes_servicio, tpl_contratos, tpl_pagos, tpl_avances_trabajo, tpl_tareas — todas creadas en supabase/migrations/202607300000_tpl_nucleo_v1.sql y ampliadas después, incluida 202608050015_tpl_cerebro_supabase_proyectos_solicitudes_v1.sql), y no queda ningún módulo `cerebro` corriendo sobre localStorage en frontend-v2/. Esta advertencia queda obsoleta; se deja el historial de la nota en vez de borrarla.
